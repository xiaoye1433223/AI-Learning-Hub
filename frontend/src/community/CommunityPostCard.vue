...
<template><article class="community-post" :data-post-id="post.id">
  ...
  <CommunityImageGallery v-if="post.coverFileId" :images="[{ fileId: post.coverFileId, alt: `${post.title || '图文'}封面` }]" />
